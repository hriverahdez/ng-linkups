...
import { NotificationSocketHandlerService } from "../../services/notification-socket-handler.service";
import { NotificationsService } from "../../services/notifications.service";
import { NotificationHelperService } from "../../../@shared/utility/notification-helper.service";
...
export class NotificationsEffect {
  constructor(
    ...
    private notificationSocketHandler: NotificationSocketHandlerService,
  ...
  loadNotificationsOnStart$ = this.actions$
    ...
    .pipe(
      ...
      switchMap(() =>
        this.store.select(fromSelectors.selectNotificationsLoaded).pipe(
          tap(loaded => {
            if (!loaded) {
